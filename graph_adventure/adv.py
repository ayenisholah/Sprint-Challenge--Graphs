...
# Create a stack of room
# Keep track of visited rooms
# As you traverse the room
# If a room has not been visited i.e it is not in stack of rooms
# Mark it as visited,
# then add to the stack of rooms and add it's coordinate to the list of traversed path
# return the length of the traversed path


# def get_room_list(roomGraph):
#     room_list = []
#     for rooms in roomGraph:
#         room_list.append(roomGraph[rooms][1])
#     return (room_list)


# rooms = get_room_list(roomGraph)
...
# def traverse_room(roomGraph, starting_room):
...
#             for next_vertex in roomGraph[v]:
#                 traversalPath.append(next_vertex)
...
def dft(starting_room):
    ...
    while s.size() > 0:
        ...
        if current_room.id not in visited:
            ...
            next_moves = current_room.getExits()
...
# Find a way to print the directions

dft(world.startingRoom)
# print(f"World first room {world.startingRoom}")
